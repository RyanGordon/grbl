...
#define defaults_h
  ...
  #define DEFAULT_X_MAX_RATE 320.0 // mm/min
  #define DEFAULT_Y_MAX_RATE 320.0 // mm/min
  #define DEFAULT_Z_MAX_RATE 320.0 // mm/min
  ...
  #define DEFAULT_STEP_PULSE_MICROSECONDS 35
  ...
  #define DEFAULT_HOMING_SEEK_RATE 320.0 // mm/min
