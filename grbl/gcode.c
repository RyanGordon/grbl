...
uint8_t gc_execute_line(char *line) 
{
  ...
  */  
  ...
  // [14. Cutter radius compensation ]: G41/42 NOT SUPPORTED. Error, if enabled while G53 is active.
  ...
  // [22. Program flow ]: No error checks required.
  ...
  */ 
  ...
  // [14. Cutter radius compensation ]: G41/42 NOT SUPPORTED
